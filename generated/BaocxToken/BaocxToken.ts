...
export class BaocxToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class BaocxToken extends ethereum.SmartContract {
  static bind(address: Address): BaocxToken {
    return new BaocxToken("BaocxToken", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): BaocxToken__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new BaocxToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<BaocxToken__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new BaocxToken__checkpointsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
...
export class LockOfCall extends ethereum.Call {
  get inputs(): LockOfCall__Inputs {
    return new LockOfCall__Inputs(this);
  }

  get outputs(): LockOfCall__Outputs {
    return new LockOfCall__Outputs(this);
  }
}

export class LockOfCall__Inputs {
  _call: LockOfCall;

  constructor(call: LockOfCall) {
    this._call = call;
  }
...
export class LockOfCall__Outputs {
  _call: LockOfCall;
